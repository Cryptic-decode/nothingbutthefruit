            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center">
                  ...
                  <a href="mailto:info@nothingbutthefruit.com" className="text-gray-300 hover:text-brand-gold transition-colors duration-200">
                ...
                <div className="flex items-center">
                  ...
                  <a href="https://wa.me/234XXXXXXXXX" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-brand-gold transition-colors duration-200">
                    +234 XXX XXX XXXX
                  </a>
                </div>
              </div>
